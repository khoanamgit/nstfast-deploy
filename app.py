...
def upload():
	...
	return render_template("upload.html", image_names=myFiles, selected_style=data)
...
def send_processed_image(filename, selected_style):
	...
	newImg = neuralStyleProcess2.neuralStyleTransfer(directoryName, filename, selected_style)
